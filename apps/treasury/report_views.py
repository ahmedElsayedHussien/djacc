...
class TreasuryReportDashboardView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
    template_name = 'treasury/reports/dashboard_links.html'
    permission_required = 'treasury.view_cashbox'

class LiveLiquidityReportView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
...
class CashInTransitReportView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
...
class InternalTransfersReportView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
...
class BankReconciliationReportView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if recon_id:
            context['data'] = ReportService.bank_reconciliation_report(int(recon_id))
            context['selected_recon'] = int(recon_id)
        return context

class BankChargesInterestReportView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
